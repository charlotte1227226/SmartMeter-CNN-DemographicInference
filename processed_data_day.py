...
output_path = "/Users/zhongboan/Desktop/python/CER Electricity Revised March 2012/processed_week_data_day/processed_week_data_day_File2.txt"
...
for i in range(0, len(col3_values), 24):
